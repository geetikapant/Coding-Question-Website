...
<body>
    <div class="question" style="height:100%;">
        <u>Question</u><br>
     Vikram buys an old scooter for Rs. A and spends Rs.B on its repairs. If he sells the scooter for Rs.C, what is his gain %?<br>
     Write a C program to compute the gain %.<br>
     Input Format:<br>
