...
<body>
    <div class="question" style="height:100%;">
        <u>Question</u><br>
 Each Sunday, a newspaper agency sells x copies of a certain newspaper for Rs. a per copy. The cost to the agency of each newspaper is Rs.b. The agency pays a fixed cost for storage, dilivery and so on of Rs.100 per Sunday. The newspaper agency wants to calculate the profit obtained on Sundays. Can you please help them out by writing a C program to compute the profit given x, a and b.<br>
 Input Format:<br>
