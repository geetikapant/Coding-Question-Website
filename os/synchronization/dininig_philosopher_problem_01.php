...
<body>
    <div class="question" style="height:100%;">
        <u>Question</u><br>
 There are five philosophers A,B,C,D,E. They sat at a round table for dinner. To complete dinner each must need 2 Forks. but there are only five Forks available on table. They take in such a manner that, first take left Fork and next right Fork. But problem is they try to take at same time. Since they are trying at same time, Fork 1,2,3,4,5 taken by philosopher A,B,C,D,E respectively. And each one tries to get right side Fork. But no one found  available Fork. And also that each one thinks that someone will release the fork and then i can eat. To avoid this situation, Last friend E first try to take right side fork and then left side fork.i.e person E tries to take 4th Fork instead of 5th one. Since 4th Fork already taken by the person D, he gets nothing. But he  left 5th Fork. Now the philosopher A will take this 5th Fork and complete dinner. Next the philosopher B takes 1st fork and completes and release 1st and 2nd. This continuous until all finishes dinner.
  </div> 
                ...
                if(philID==(n-1)){<br>
                    ...
                    if(philID==(n-1)){<br>
                        ...
                        if(ForkAvil[philID].taken == 0){<br>
                           ...
                           <br> printf("Fork %d taken by Philosopher %d\n",philID+1,philID+1);<br>
                        }else{<br>
                            printf("Philosopher %d is waiting for Fork %d\n",philID+1,philID+1);<br>
                        }<br>
                    }<br>
