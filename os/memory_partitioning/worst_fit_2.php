...
cout<<"File Number File Size Block Number Block Size Fragment\n";<br>
    for(int i = 0;i&lt;m;i++){<br>
         for(int j = 0; j&lt;n ;j++){<br>
             sub =0;<br>
              if(arr_batch[j]>arr_file[i] &&en[j] != 1){<br>
